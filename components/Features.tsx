...
const Features = () => {
  return (
    <section className="flex flex-col items-center justify-center overflow-hidden bg-center bg-no-repeat py-24">
...
const FeatureItem = ({ title, icon, description }: FeatureItem) => {
  return (
    <li className="flex w-full flex-1 flex-col items-start">
      ...
      <p className="text-[16px] font-[400] bg-white/80 text-gray-400 lg:mt-[30px] lg:bg-none">
        {description}
      </p>
    </li>
  );
